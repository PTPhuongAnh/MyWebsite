...
String query = "SELECT  comfirm.name,comfirm.email,comfirm.address,comfirm.phone,orders.o_date,orders.o_quantity,orders.o_id,orders.u_id FROM orders INNER JOIN comfirm ON orders.u_id = comfirm.u_id ORDER BY o_date DESC;";
