...
<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    CategoryDao cate=new CategoryDao(DbCon.getConnection());
	  ...
	  if(request.getParameter("submit")!=null&&auth!=null)
	    {
	    ...
	    <%            
	    	...
	    	if (auth==null) response.sendRedirect("login.jsp?msg=ok");
	    }
...
if(cart_list!=null){
	for(Cart c:cartProuduct){%>
		...
		<td><a class="btn btn-sm btn-danger" href="remove-cart?id=<%=c.getId()%>">Hủy</a></td>
		</tr>
	<%}
}
